    ...
    <div class="col-12 rounded">
        <div class="row col-12 p-3 rounded mx-auto">
            <div class="col-12 col-md-4 d-flex align-items-center justify-content-center flex-column bg-light p-5">
                <img src="../img/personita.jpg" class="rounded-circle img-fluid d-flex align-items-center justify-content-center" alt="Foto de perfil">
            ...
            <div class="col-12 col-md-8 p-5">
                ...
                <form method="POST" id="form-abm">
                    <h3 class="mb-2">Aqui puedes editar los datos de su perfil</h3>
